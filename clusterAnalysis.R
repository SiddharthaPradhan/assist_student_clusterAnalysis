...
working.data <- data %>% select(-c("StuID","TeaIDPre","ClaIDPre","ClaIDEnd","TeaIDEnd","post_total_math_score","num_problems_parts_used_bottom_out_hint","num_problem_parts_hints_accessed","gaimScore"))
